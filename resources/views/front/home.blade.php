...
<div class="job-category">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="all">
                    <a href="{{ route('job_categories') }}" class="btn btn-primary">Todas as Categorias</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <div class="item d-flex justify-content-start">
                    <div class="logo">
                        <img src="{{ asset('dist-front/uploads/logo1.png') }}" alt="" />
                    </div>
                    <div class="text">
                        <h3>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="item d-flex justify-content-start">
                    <div class="logo">
                        <img src="{{ asset('dist-front/uploads/logo2.png') }}" alt="" />
                    </div>
                    <div class="text">
                        <h3>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="item d-flex justify-content-start">
                    <div class="logo">
                        <img src="{{ asset('dist-front/uploads/logo4.png') }}" alt="" />
                    </div>
                    <div class="text">
                        <h3>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="item d-flex justify-content-start">
                    <div class="logo">
                        <img src="{{ asset('dist-front/uploads/logo5.png') }}" alt="" />
                    </div>
                    <div class="text">
                        <h3>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="item d-flex justify-content-start">
                    <div class="logo">
                        <img src="{{ asset('front-dist/uploads/logo6.png') }}" alt="" />
                    </div>
                    <div class="text">
                        <h3>
        ...
        <div class="row">
            <div class="col-12">
                <div class="testimonial-carousel owl-carousel">
                    <div class="item">
                        <div class="photo">
                            <img src="{{ asset('front-dist/uploads/t1.jpg') }}" alt="" />
                        </div>
                        <div class="text">
                            <h4>Robert Krol</h4>
                            <p>CEO, ABC Company</p>
                    ...
                    <div class="item">
                        <div class="photo">
                            <img src="{{ asset('front-dist/uploads/t2.jpg') }}" alt="" />
                        </div>
                        <div class="text">
                            <h4>Sal Harvey</h4>
